          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto border-t pt-8">
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground">不可見性 (PSNR)</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold tracking-tight mb-1">0.5s</div>
                <div className="text-sm text-muted-foreground">處理速度</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold tracking-tight mb-1">AES</div>
                <div className="text-sm text-muted-foreground">加密標準</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold tracking-tight mb-1">Client</div>
                <div className="text-sm text-muted-foreground">本地端處理</div>
              </div>
            </div>
          </div>
        </section>
                 ...
                 <Card className="relative bg-background/50 border-primary/20 backdrop-blur-sm overflow-hidden">
                   <div className="p-8 space-y-6">
                     ...
                     <div className="font-mono text-sm space-y-2 text-muted-foreground">
                       ...
                       <div className="flex justify-between">
                         <span>Embedding_Strength:</span>
                         <span className="text-foreground">45.0 (alpha)</span>
                       </div>
                       <div className="flex justify-between">
